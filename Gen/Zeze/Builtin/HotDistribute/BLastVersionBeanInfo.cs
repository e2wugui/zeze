...
{
    [System.Serializable]
    public sealed class BLastVersionBeanInfo : Zeze.Util.ConfBean
    {
        public string Name;
        public System.Collections.Generic.List<Zeze.Builtin.HotDistribute.BVariable> Variables;

        public BLastVersionBeanInfo()
        {
            Name = "";
            Variables = new System.Collections.Generic.List<Zeze.Builtin.HotDistribute.BVariable>();
        }

        public const long TYPEID = -6575391224958548024;
        public override long TypeId => -6575391224958548024;
