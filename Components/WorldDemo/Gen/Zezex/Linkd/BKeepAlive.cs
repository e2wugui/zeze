...
namespace Zezex.Linkd
{
    ...
    public sealed class BKeepAlive : Zeze.Util.ConfBean
    {
        ...
        public const long TYPEID = 8485573885308318241;
        public override long TypeId => 8485573885308318241;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zezex.Linkd.BKeepAlive: {").Append(Environment.NewLine);
            level += 4;
