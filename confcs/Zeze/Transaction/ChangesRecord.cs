...
#if USE_CONFCS
        Zeze.Util.ConfBean NewValueBean();
        Zeze.Util.ConfBean Get(object key);
        void Put(object key, Zeze.Util.ConfBean value);
#else
        Zeze.Transaction.Bean NewValueBean();
        Zeze.Transaction.Bean Get(object key);
        void Put(object key, Zeze.Transaction.Bean value);
#endif
