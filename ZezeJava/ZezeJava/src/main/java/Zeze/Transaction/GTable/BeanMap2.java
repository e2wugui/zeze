...
public final class BeanMap2<C, V extends Bean, VReadOnly> extends Bean implements Map<C, V>, BeanMap2ReadOnly<C, V, VReadOnly> {
	...
	private final Zeze.Transaction.Collections.PMap2<C, V> pMap2;
	...
	public BeanMap2<C, V, VReadOnly> copy() {
		var _c_ = new BeanMap2<C, V, VReadOnly>(pMap2.getMeta());
		_c_.assign(this);
		return _c_;
	}
	...
	public boolean isEmpty() {
		return pMap2.isEmpty();
	}

	@Override
	public boolean containsKey(Object key) {
		return pMap2.containsKey(key);
	}

	@Override
	public boolean containsValue(Object value) {
		return pMap2.containsValue(value);
	}

	@Override
	public V get(Object key) {
		return pMap2.get(key);
	}

	@Nullable
	@Override
	public V put(C key, V value) {
		return pMap2.put(key, value);
	}

	@Override
	public V remove(Object key) {
		return pMap2.remove(key);
	}
	...
	public void encodeSQLStatement(java.util.ArrayList<String> _p_, Zeze.Serialize.SQLStatement _s_) {
		var _pn_ = Bean.parentsToName(_p_);
		_s_.appendString(_pn_ + "Map2", Zeze.Serialize.Helper.encodeJson(pMap2));
	}
