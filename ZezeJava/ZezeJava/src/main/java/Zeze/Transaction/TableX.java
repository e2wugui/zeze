...
//			throw new IllegalStateException("Global Can Not Work With CheckpointMode.Period.");
		...
		try {
			...
			try {
				...
				case StateShare:
					...
					rpc.Result.reducedTid = r.getTid();
					r.setTid(null);
					ZezeCounter.instance.tableCounter(getId(), ZezeCounter.TableMetric.REDUCE_INVALID).increment();
	...
	@Override
	public long walkMemoryAny(@NotNull TableWalkHandle<Object, Bean> handle) throws Exception {
