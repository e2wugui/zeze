...
public final class BFlushReady extends Zeze.Transaction.Bean implements BFlushReadyReadOnly {
    ...
    private static final class Log__OnzTid extends Zeze.Transaction.Logs.LogLong {
        public Log__OnzTid(BFlushReady _b_, int _i_, long _v_) { super(_b_, _i_, _v_); }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.Onz.BFlushReady: {").append(System.lineSeparator());
        _l_ += 4;
