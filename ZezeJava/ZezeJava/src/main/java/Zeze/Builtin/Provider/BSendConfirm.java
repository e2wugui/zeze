...
public final class BSendConfirm extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -1383888801685838025L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Builtin.Provider.BSendConfirm: {").append(System.lineSeparator());
        level += 4;
