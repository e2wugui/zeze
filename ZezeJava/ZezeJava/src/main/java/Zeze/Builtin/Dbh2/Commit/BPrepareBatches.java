...
public final class BPrepareBatches extends Zeze.Transaction.Bean implements BPrepareBatchesReadOnly {
    ...
    private static final Zeze.Transaction.Collections.Map2Meta<String, Zeze.Builtin.Dbh2.BPrepareBatch> meta2_Datas
            = Zeze.Transaction.Collections.Map2Meta.get(String.class, Zeze.Builtin.Dbh2.BPrepareBatch.class);
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        if (!_Datas.isEmpty()) {
            ...
            for (var _e_ : _Datas.entrySet()) {
                if (++_n_ > 1000) {
                    _s_.append(_i2_).append("...[").append(_Datas.size()).append("]\n");
                    break;
                }
