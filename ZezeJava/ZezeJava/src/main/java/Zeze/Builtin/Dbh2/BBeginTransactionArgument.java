...
public final class BBeginTransactionArgument extends Zeze.Transaction.Bean implements BBeginTransactionArgumentReadOnly {
    ...
    @Override
    public Zeze.Builtin.Dbh2.BBeginTransactionArgument.Data toData() {
        var data = new Zeze.Builtin.Dbh2.BBeginTransactionArgument.Data();
        data.assign(this);
        return data;
    }
    ...
    public void assign(Zeze.Transaction.Data other) {
        assign((Zeze.Builtin.Dbh2.BBeginTransactionArgument.Data)other);
    }

    public void assign(BBeginTransactionArgument.Data other) {
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    @SuppressWarnings("deprecation")
    public Data(String _Database_, String _Table_, long _TransactionId_) {
        if (_Database_ == null)
            throw new IllegalArgumentException();
        _Database = _Database_;
        if (_Table_ == null)
    ...
    @Override
    public BBeginTransactionArgument.Data copy() {
        var copy = new BBeginTransactionArgument.Data();
        copy.assign(this);
        return copy;
    }

    public static void swap(BBeginTransactionArgument.Data a, BBeginTransactionArgument.Data b) {
        var save = a.copy();
        a.assign(b);
        b.assign(save);
    }
