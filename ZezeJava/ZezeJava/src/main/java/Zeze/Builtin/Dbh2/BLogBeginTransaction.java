...
public final class BLogBeginTransaction extends Zeze.Transaction.Bean implements BLogBeginTransactionReadOnly {
    ...
    public BLogBeginTransaction() {
    }

    @SuppressWarnings("deprecation")
    public BLogBeginTransaction(long _TransactionId_) {
        _TransactionId = _TransactionId_;
    }

    @Override
    public Zeze.Builtin.Dbh2.BLogBeginTransactionData toData() {
        var data = new Zeze.Builtin.Dbh2.BLogBeginTransactionData();
        data.assign(this);
        return data;
    }
    ...
    public void assign(Zeze.Transaction.Data other) {
        assign((Zeze.Builtin.Dbh2.BLogBeginTransactionData)other);
    }
    ...
    public BLogBeginTransaction copyIfManaged() {
        return isManaged() ? copy() : this;
    }

    @Override
    public BLogBeginTransaction copy() {
        var copy = new BLogBeginTransaction();
        copy.assign(this);
        return copy;
    }
    ...
    public static void swap(BLogBeginTransaction a, BLogBeginTransaction b) {
        BLogBeginTransaction save = a.copy();
        a.assign(b);
        b.assign(save);
    }
    ...
    private static final class Log__TransactionId extends Zeze.Transaction.Logs.LogLong {
        public Log__TransactionId(BLogBeginTransaction bean, int varId, long value) { super(bean, varId, value); }

        @Override
        public void commit() { ((BLogBeginTransaction)getBelong())._TransactionId = value; }
    }
