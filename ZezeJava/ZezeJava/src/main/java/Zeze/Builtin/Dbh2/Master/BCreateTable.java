...
public final class BCreateTable extends Zeze.Transaction.Bean implements BCreateTableReadOnly {
    ...
    public Zeze.Builtin.Dbh2.Master.BCreateTable.Data toData() {
        var _d_ = new Zeze.Builtin.Dbh2.Master.BCreateTable.Data();
        _d_.assign(this);
        return _d_;
    }
    ...
    public void assign(Zeze.Transaction.Data _o_) {
        assign((Zeze.Builtin.Dbh2.Master.BCreateTable.Data)_o_);
    }

    public void assign(BCreateTable.Data _o_) {
        setDatabase(_o_._Database);
        setTable(_o_._Table);
        _unknown_ = null;
    }

    public void assign(BCreateTable _o_) {
    ...
    public BCreateTable copy() {
        var _c_ = new BCreateTable();
        _c_.assign(this);
        return _c_;
    }

    public static void swap(BCreateTable _a_, BCreateTable _b_) {
        var _s_ = _a_.copy();
        _a_.assign(_b_);
        _b_.assign(_s_);
    }
    ...
    private static final class Log__Database extends Zeze.Transaction.Logs.LogString {
        public Log__Database(BCreateTable _b_, int _i_, String _v_) { super(_b_, _i_, _v_); }
    ...
    private static final class Log__Table extends Zeze.Transaction.Logs.LogString {
        public Log__Table(BCreateTable _b_, int _i_, String _v_) { super(_b_, _i_, _v_); }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.Dbh2.Master.BCreateTable: {").append(System.lineSeparator());
        _l_ += 4;
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BCreateTable))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BCreateTable)_o_;
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public Zeze.Builtin.Dbh2.Master.BCreateTable toBean() {
        var _b_ = new Zeze.Builtin.Dbh2.Master.BCreateTable();
        _b_.assign(this);
        return _b_;
    }
    ...
    public BCreateTable.Data copy() {
        var _c_ = new BCreateTable.Data();
        _c_.assign(this);
        return _c_;
    }

    public static void swap(BCreateTable.Data _a_, BCreateTable.Data _b_) {
        var _s_ = _a_.copy();
        _a_.assign(_b_);
        _b_.assign(_s_);
    }
