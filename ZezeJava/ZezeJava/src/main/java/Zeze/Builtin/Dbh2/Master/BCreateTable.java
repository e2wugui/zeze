...
public final class BCreateTable extends Zeze.Transaction.Bean implements BCreateTableReadOnly {
    ...
    static {
        ...
        try {
            vh_Database = _l_.findVarHandle(BCreateTable.class, "_Database", String.class);
            vh_Table = _l_.findVarHandle(BCreateTable.class, "_Table", String.class);
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.Dbh2.Master.BCreateTable: {\n");
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BCreateTable.Data))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BCreateTable.Data)_o_;
