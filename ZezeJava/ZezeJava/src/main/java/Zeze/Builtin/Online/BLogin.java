...
public final class BLogin extends Zeze.Transaction.Bean implements BLoginReadOnly {
    ...
    private static final class Log__ClientId extends Zeze.Transaction.Logs.LogString {
        public Log__ClientId(BLogin _b_, int _i_, String _v_) { super(_b_, _i_, _v_); }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.Online.BLogin: {").append(System.lineSeparator());
        _l_ += 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append("ClientId=").append(getClientId()).append(System.lineSeparator());
        _l_ -= 4;
