...
public final class BLocal extends Zeze.Transaction.Bean {
    ...
    private final Zeze.Transaction.Collections.CollMap2<String, Zeze.Builtin.Online.BAny> _Datas;
    ...
    public Zeze.Transaction.Collections.CollMap2<String, Zeze.Builtin.Online.BAny> getDatas() {
        return _Datas;
    }
    ...
    public BLocal(int _varId_) {
        super(_varId_);
        _Datas = new Zeze.Transaction.Collections.CollMap2<>(String.class, Zeze.Builtin.Online.BAny.class);
        _Datas.VariableId = 2;
    }
