...
public final class BLocal extends Zeze.Transaction.Bean {
    ...
    private static final class Log__Datas extends Zeze.Transaction.Collections.PMap.LogV<String, Zeze.Builtin.Online.BAny> {
        public Log__Datas(BLocal host, org.pcollections.PMap<String, Zeze.Builtin.Online.BAny> value) { super(host, value); }
        @Override
