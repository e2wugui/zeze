...
public final class BAppendFile extends Zeze.Transaction.Bean implements BAppendFileReadOnly {
    ...
    public Zeze.Builtin.HotDistribute.BAppendFile.Data toData() {
        var _d_ = new Zeze.Builtin.HotDistribute.BAppendFile.Data();
        _d_.assign(this);
        return _d_;
    }
    ...
    public void assign(Zeze.Transaction.Data _o_) {
        assign((Zeze.Builtin.HotDistribute.BAppendFile.Data)_o_);
    }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.HotDistribute.BAppendFile: {").append(System.lineSeparator());
        _l_ += 4;
    ...
    public void followerApply(Zeze.Transaction.Log _l_) {
        ...
        for (var _i_ = _vs_.iterator(); _i_.moveToNext(); ) {
            ...
            switch (_v_.getVariableId()) {
                ...
                case 2: _Offset = _v_.longValue(); break;
                case 3: _Chunk = _v_.binaryValue(); break;
            }
        }
    }
    ...
    public java.util.ArrayList<Zeze.Builtin.HotDistribute.BVariable.Data> variables() {
        ...
        _v_.add(new Zeze.Builtin.HotDistribute.BVariable.Data(2, "Offset", "long", "", ""));
        _v_.add(new Zeze.Builtin.HotDistribute.BVariable.Data(3, "Chunk", "binary", "", ""));
        return _v_;
    }
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public Zeze.Builtin.HotDistribute.BAppendFile toBean() {
        var _b_ = new Zeze.Builtin.HotDistribute.BAppendFile();
        _b_.assign(this);
        return _b_;
    }
