...
public final class BOpenFileResult extends Zeze.Transaction.Bean implements BOpenFileResultReadOnly {
    public static final long TYPEID = -52811376144938923L;
    ...
    static {
        ...
        try {
            vh_Offset = _l_.findVarHandle(BOpenFileResult.class, "_Offset", long.class);
    ...
    public void setOffset(long _v_) {
        ...
        _t_.putLog(new Zeze.Transaction.Logs.LogLong(this, 1, vh_Offset, _v_));
    }
    ...
    @Override
    public Zeze.Builtin.HotDistribute.BOpenFileResult.Data toData() {
        var _d_ = new Zeze.Builtin.HotDistribute.BOpenFileResult.Data();
        _d_.assign(this);
        return _d_;
    }
    ...
    public void assign(Zeze.Transaction.Data _o_) {
        assign((Zeze.Builtin.HotDistribute.BOpenFileResult.Data)_o_);
    }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.HotDistribute.BOpenFileResult: {\n");
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    @Override
    public Zeze.Builtin.HotDistribute.BOpenFileResult toBean() {
        var _b_ = new Zeze.Builtin.HotDistribute.BOpenFileResult();
        _b_.assign(this);
        return _b_;
    }
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BOpenFileResult.Data))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BOpenFileResult.Data)_o_;
