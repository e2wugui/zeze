...
public final class BOpenFileResult extends Zeze.Transaction.Bean implements BOpenFileResultReadOnly {
    ...
    public Zeze.Builtin.HotDistribute.BOpenFileResult.Data toData() {
        var data = new Zeze.Builtin.HotDistribute.BOpenFileResult.Data();
        data.assign(this);
        return data;
    }
    ...
    public void assign(Zeze.Transaction.Data other) {
        assign((Zeze.Builtin.HotDistribute.BOpenFileResult.Data)other);
    }
    ...
    public void buildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Builtin.HotDistribute.BOpenFileResult: {").append(System.lineSeparator());
        level += 4;
    ...
    public void followerApply(Zeze.Transaction.Log log) {
        ...
        for (var it = vars.iterator(); it.moveToNext(); ) {
            ...
            switch (vlog.getVariableId()) {
                case 1: _Offset = vlog.longValue(); break;
            }
        }
    }
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public Zeze.Builtin.HotDistribute.BOpenFileResult toBean() {
        var bean = new Zeze.Builtin.HotDistribute.BOpenFileResult();
        bean.assign(this);
        return bean;
    }
