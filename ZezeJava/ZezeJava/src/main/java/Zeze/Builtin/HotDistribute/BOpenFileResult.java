...
public final class BOpenFileResult extends Zeze.Transaction.Bean implements BOpenFileResultReadOnly {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.HotDistribute.BOpenFileResult: {").append(System.lineSeparator());
        _l_ += 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Offset=").append(getOffset()).append(System.lineSeparator());
        _l_ -= 4;
