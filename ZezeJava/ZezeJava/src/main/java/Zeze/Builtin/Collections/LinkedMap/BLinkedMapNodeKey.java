...
public final class BLinkedMapNodeKey implements Zeze.Transaction.BeanKey, Comparable<BLinkedMapNodeKey> {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.Collections.LinkedMap.BLinkedMapNodeKey: {").append(System.lineSeparator());
        _l_ += 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Name=").append(_Name).append(',').append(System.lineSeparator());
        _s_.append(Zeze.Util.Str.indent(_l_)).append("NodeId=").append(_NodeId).append(System.lineSeparator());
        _l_ -= 4;
