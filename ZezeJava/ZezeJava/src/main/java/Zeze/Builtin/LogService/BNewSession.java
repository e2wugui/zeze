...
public final class BNewSession extends Zeze.Transaction.Bean implements BNewSessionReadOnly {
    ...
    public String getLogName() {
        ...
        if (_t_ == null)
            return _LogName;
        var log = (Log__LogName)_t_.getLog(objectId() + 1);
    ...
    public void setLogName(String _v_) {
        ...
        _t_.putLog(new Log__LogName(this, 1, _v_));
    }
    ...
    private static final class Log__LogName extends Zeze.Transaction.Logs.LogString {
        public Log__LogName(BNewSession _b_, int _i_, String _v_) { super(_b_, _i_, _v_); }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.LogService.BNewSession: {").append(System.lineSeparator());
        _l_ += 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append("LogName=").append(getLogName()).append(System.lineSeparator());
        _l_ -= 4;
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.LogService.BNewSession: {").append(System.lineSeparator());
        _l_ += 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append("LogName=").append(_LogName).append(System.lineSeparator());
        _l_ -= 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append('}');
    }
