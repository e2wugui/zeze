...
public class Search extends Zeze.Net.Rpc<Zeze.Builtin.LogService.BSession.Data, Zeze.Builtin.LogService.BResult.Data> {
    ...
    public Search(Zeze.Builtin.LogService.BSession.Data arg) {
        Argument = arg;
        Result = new Zeze.Builtin.LogService.BResult.Data();
    }
}
