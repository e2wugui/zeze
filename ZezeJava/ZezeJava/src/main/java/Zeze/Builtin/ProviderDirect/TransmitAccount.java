...
// 默认不启用事务，由协议实现自己控制。
public class TransmitAccount extends Zeze.Net.Protocol<Zeze.Builtin.ProviderDirect.BTransmitAccount.Data> {
    ...
    public TransmitAccount() {
        Argument = new Zeze.Builtin.ProviderDirect.BTransmitAccount.Data();
    }

    public TransmitAccount(Zeze.Builtin.ProviderDirect.BTransmitAccount.Data arg) {
        Argument = arg;
    }
}
