...
public final class BLoginKey implements Zeze.Transaction.BeanKey, Comparable<BLoginKey> {
    ...
    public BLoginKey(String _Account_, String _ClientId_) {
        if (_Account_ == null)
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.ProviderDirect.BLoginKey: {\n");
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BLoginKey))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BLoginKey)_o_;
    ...
    @Override
    public int compareTo(BLoginKey _o_) {
        if (_o_ == this)
            return 0;
        if (_o_ != null) {
            int _c_;
