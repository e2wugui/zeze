...
public final class BGlobalThreadId implements Zeze.Transaction.BeanKey, Comparable<BGlobalThreadId> {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.Threading.BGlobalThreadId: {").append(System.lineSeparator());
        _l_ += 4;
        _s_.append(Zeze.Util.Str.indent(_l_)).append("ServerId=").append(_ServerId).append(',').append(System.lineSeparator());
        _s_.append(Zeze.Util.Str.indent(_l_)).append("ThreadId=").append(_ThreadId).append(System.lineSeparator());
        _l_ -= 4;
