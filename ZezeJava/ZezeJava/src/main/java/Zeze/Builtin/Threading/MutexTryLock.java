...
public class MutexTryLock extends Zeze.Net.Rpc<Zeze.Builtin.Threading.BMutexTryLock.Data, Zeze.Transaction.EmptyBean.Data> {
    ...
    public MutexTryLock() {
        Argument = new Zeze.Builtin.Threading.BMutexTryLock.Data();
        Result = Zeze.Transaction.EmptyBean.Data.instance;
    }

    public MutexTryLock(Zeze.Builtin.Threading.BMutexTryLock.Data arg) {
        Argument = arg;
        Result = Zeze.Transaction.EmptyBean.Data.instance;
    }
}
