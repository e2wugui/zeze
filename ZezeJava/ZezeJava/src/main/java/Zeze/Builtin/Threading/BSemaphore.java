...
public final class BSemaphore extends Zeze.Transaction.Bean implements BSemaphoreReadOnly {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.Threading.BSemaphore: {\n");
        _s_.append(_i1_).append("LockName=");
        getLockName().buildString(_s_, _l_ + 8);
        _s_.append(",\n");
        _s_.append(_i1_).append("Permits=").append(getPermits()).append(",\n");
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append(",\n");
        _s_.append(_i1_).append("Permits=").append(_Permits).append(",\n");
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BSemaphore.Data))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BSemaphore.Data)_o_;
        if (!_LockName.equals(_b_._LockName))
            return false;
        if (_Permits != _b_._Permits)
            return false;
