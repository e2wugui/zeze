...
public final class BTConditionKillMonster extends Zeze.Transaction.Bean implements BTConditionKillMonsterReadOnly {
    ...
    protected void initChildrenRootInfoWithRedo(Zeze.Transaction.Record.RootInfo root) {
        ...
        _monstersKilled.initRootInfoWithRedo(root, this);
    }
    ...
    public void decodeResultSet(java.util.ArrayList<String> parents, java.sql.ResultSet rs) throws java.sql.SQLException {
        ...
        Zeze.Serialize.Helper.decodeJsonMap(this, "monstersKilled", _monstersKilled, rs.getString(_parents_name_ + "monstersKilled"));
    }
    ...
    public void encodeSQLStatement(java.util.ArrayList<String> parents, Zeze.Serialize.SQLStatement st) {
        ...
        st.appendString(_parents_name_ + "monstersKilled", Zeze.Serialize.Helper.encodeJson(_monstersKilled));
    }
    ...
    public java.util.List<Zeze.Transaction.Bean.Variable> variables() {
        ...
        vars.add(new Zeze.Transaction.Bean.Variable(2, "monstersKilled", "map", "long", "int"));
        return vars;
    }
