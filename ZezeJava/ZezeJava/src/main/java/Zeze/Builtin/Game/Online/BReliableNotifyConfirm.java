...
public final class BReliableNotifyConfirm extends Zeze.Transaction.Bean implements BReliableNotifyConfirmReadOnly {
    ...
    public void setReliableNotifyConfirmIndex(long _v_) {
        ...
        _t_.putLog(new Zeze.Transaction.Logs.LogLong(this, 1, vh_ReliableNotifyConfirmIndex, _v_));
    }
    ...
    public void setSync(boolean _v_) {
        ...
        var _t_ = Zeze.Transaction.Transaction.getCurrentVerifyWrite(this);
        _t_.putLog(new Zeze.Transaction.Logs.LogBool(this, 2, vh_Sync, _v_));
    }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.Game.Online.BReliableNotifyConfirm: {\n");
