...
public final class BTask extends Zeze.Transaction.Bean implements BTaskReadOnly {
    ...
    public java.util.ArrayList<Zeze.Builtin.HotDistribute.BVariable.Data> variables() {
        ...
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(2, "taskId", "long", "", ""));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(3, "taskType", "string", "", ""));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(4, "taskState", "int", "", ""));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(5, "taskName", "string", "", ""));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(6, "taskDescription", "string", "", ""));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(7, "preTaskIds", "list", "", "long"));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(8, "currentPhaseId", "long", "", ""));
        vars.add(new Zeze.Builtin.HotDistribute.BVariable.Data(9, "taskPhases", "map", "long", "BTaskPhase"));
