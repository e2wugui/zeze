...
public final class BOfflineTimers extends Zeze.Transaction.Bean implements BOfflineTimersReadOnly {
    ...
    private static final Zeze.Transaction.Collections.Map1Meta<String, Integer> meta2_OfflineTimers
            = Zeze.Transaction.Collections.Map1Meta.get(String.class, Integer.class);
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.Timer.BOfflineTimers: {\n");
        _s_.append(_i1_).append("OfflineTimers={");
        if (!_OfflineTimers.isEmpty()) {
            _s_.append('\n');
            int _n_ = 0;
            for (var _e_ : _OfflineTimers.entrySet()) {
                if (++_n_ > 1000) {
                    _s_.append(_i2_).append("...[").append(_OfflineTimers.size()).append("]\n");
                    break;
                }
