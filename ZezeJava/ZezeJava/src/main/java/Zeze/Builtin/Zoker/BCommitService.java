...
public final class BCommitService extends Zeze.Transaction.Bean implements BCommitServiceReadOnly {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("Zeze.Builtin.Zoker.BCommitService: {\n");
        _s_.append(_i1_).append("ServiceName=").append(getServiceName()).append(",\n");
        _s_.append(_i1_).append("VersionNo=").append(getVersionNo()).append('\n');
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append(_i1_).append("VersionNo=").append(_VersionNo).append('\n');
        _s_.append(Zeze.Util.Str.indent(_l_)).append('}');
    }
