...
public final class BService extends Zeze.Transaction.Bean implements BServiceReadOnly {
    ...
    private static final java.lang.invoke.VarHandle vh_Ps;

    static {
        var _l_ = java.lang.invoke.MethodHandles.lookup();
        try {
            vh_ServiceName = _l_.findVarHandle(BService.class, "_ServiceName", String.class);
            vh_State = _l_.findVarHandle(BService.class, "_State", String.class);
            vh_Ps = _l_.findVarHandle(BService.class, "_Ps", String.class);
    ...
    public void setState(String _v_) {
        ...
        var _t_ = Zeze.Transaction.Transaction.getCurrentVerifyWrite(this);
        _t_.putLog(new Zeze.Transaction.Logs.LogString(this, 2, vh_State, _v_));
    }
    ...
    public void setPs(String _v_) {
        ...
        var _t_ = Zeze.Transaction.Transaction.getCurrentVerifyWrite(this);
        _t_.putLog(new Zeze.Transaction.Logs.LogString(this, 3, vh_Ps, _v_));
    }
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BService.Data))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BService.Data)_o_;
        if (!_ServiceName.equals(_b_._ServiceName))
            return false;
        if (!_State.equals(_b_._State))
            return false;
        if (!_Ps.equals(_b_._Ps))
            return false;
        return true;
    }
}
