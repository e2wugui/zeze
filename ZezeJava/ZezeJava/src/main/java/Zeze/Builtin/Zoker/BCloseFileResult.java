...
public final class BCloseFileResult extends Zeze.Transaction.Bean implements BCloseFileResultReadOnly {
    ...
    public Zeze.Builtin.Zoker.BCloseFileResult.Data toData() {
        var _d_ = new Zeze.Builtin.Zoker.BCloseFileResult.Data();
        _d_.assign(this);
        return _d_;
    }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        _s_.append(Zeze.Util.Str.indent(_l_)).append("Zeze.Builtin.Zoker.BCloseFileResult: {").append(System.lineSeparator());
        _l_ += 4;
        _l_ -= 4;
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public Zeze.Builtin.Zoker.BCloseFileResult toBean() {
        var _b_ = new Zeze.Builtin.Zoker.BCloseFileResult();
        _b_.assign(this);
        return _b_;
    }
