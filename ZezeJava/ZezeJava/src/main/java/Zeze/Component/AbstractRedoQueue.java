...
public abstract class AbstractRedoQueue extends Zeze.IModule {
    public String getFullName() { return "Zeze.Beans.RedoQueue"; }
    public String getName() { return "RedoQueue"; }
