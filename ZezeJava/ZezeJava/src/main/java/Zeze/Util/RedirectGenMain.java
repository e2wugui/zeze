 ...
 * 4. 这个类创建原始内建模块实例，并执行generateRedirectSources生成代码。
 */
public final class RedirectGenMain {
	...
	public static void main(String[] args) {
		var srcRoot = System.getProperty("GenFileSrcRoot");
		if (srcRoot == null) {
		...
		GenModule.instance.generateRedirectSources(srcRoot, app, new Class[]{
