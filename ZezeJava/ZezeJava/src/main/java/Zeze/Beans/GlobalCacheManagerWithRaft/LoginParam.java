...
public final class LoginParam extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 2881471292756569593L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.GlobalCacheManagerWithRaft.LoginParam: {").append(System.lineSeparator());
        level += 4;
