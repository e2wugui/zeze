...
public final class AcquiredState extends Zeze.Raft.RocksRaft.Bean {
    ...
    public static final long TYPEID = -3725217230826049232L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.GlobalCacheManagerWithRaft.AcquiredState: {").append(System.lineSeparator());
        level += 4;
