...
public final class ReduceParam extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -5927738941172057956L;
    ...
    private static final class Log__GlobalTableKey extends Zeze.Transaction.Log1<ReduceParam, Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey> {
        public Log__GlobalTableKey(ReduceParam self, Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey value) { super(self, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.GlobalCacheManagerWithRaft.ReduceParam: {").append(System.lineSeparator());
        level += 4;
