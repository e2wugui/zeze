...
public final class CacheState extends Zeze.Raft.RocksRaft.Bean {
    ...
    public static final long TYPEID = -3700479291866966562L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.GlobalCacheManagerWithRaft.CacheState: {").append(System.lineSeparator());
        level += 4;
