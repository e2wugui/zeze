...
public final class BRankValue extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -1892548547541607139L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Rank.BRankValue: {").append(System.lineSeparator());
        level += 4;
