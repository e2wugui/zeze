...
public final class BBag extends Zeze.Transaction.Bean {
    ...
    private final Zeze.Transaction.Collections.PMap2<Integer, Zeze.Beans.Game.Bag.BItem> _Items; // key is bag position
    ...
    public Zeze.Transaction.Collections.PMap2<Integer, Zeze.Beans.Game.Bag.BItem> getItems() {
        return _Items;
    }
    ...
    public static final long TYPEID = 2844494039708458018L;
    ...
    private static final class Log__Items extends Zeze.Transaction.Collections.PMap.LogV<Integer, Zeze.Beans.Game.Bag.BItem> {
        public Log__Items(BBag host, org.pcollections.PMap<Integer, Zeze.Beans.Game.Bag.BItem> value) { super(host, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Bag.BBag: {").append(System.lineSeparator());
        level += 4;
