...
public final class BReliableNotifyConfirm extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 4003270441446701916L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Online.BReliableNotifyConfirm: {").append(System.lineSeparator());
        level += 4;
