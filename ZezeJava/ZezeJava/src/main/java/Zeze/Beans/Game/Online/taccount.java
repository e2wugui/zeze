...
public final class taccount extends Zeze.Transaction.TableX<String, Zeze.Beans.Game.Online.BAccount> {
    public taccount() {
        super("Zeze_Beans_Game_Online_taccount");
    }
    ...
    @Override
    public Zeze.Beans.Game.Online.BAccount NewValue() {
        return new Zeze.Beans.Game.Online.BAccount();
    }
