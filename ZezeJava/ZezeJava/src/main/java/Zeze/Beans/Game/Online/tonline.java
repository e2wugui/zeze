...
public final class tonline extends Zeze.Transaction.TableX<Long, Zeze.Beans.Game.Online.BOnline> {
    public tonline() {
        super("Zeze_Beans_Game_Online_tonline");
    }
    ...
    @Override
    public Zeze.Beans.Game.Online.BOnline NewValue() {
        return new Zeze.Beans.Game.Online.BOnline();
    }
