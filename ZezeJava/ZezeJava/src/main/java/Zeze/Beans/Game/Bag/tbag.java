...
public final class tbag extends Zeze.Transaction.TableX<String, Zeze.Beans.Game.Bag.BBag> {
    public tbag() {
        super("Zeze_Beans_Game_Bag_tbag");
    }
    ...
    @Override
    public Zeze.Beans.Game.Bag.BBag NewValue() {
        return new Zeze.Beans.Game.Bag.BBag();
    }
    ...
    public Zeze.Transaction.ChangeVariableCollector CreateChangeVariableCollector(int variableId) {
        switch (variableId) {
            ...
            case 2: return new Zeze.Transaction.ChangeVariableCollectorMap(() -> new Zeze.Transaction.ChangeNoteMap2<Integer, Zeze.Beans.Game.Bag.BItem>(null));
            default: return null;
        }
    }
}
