...
public final class BItem extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 3472511193920401251L;
    ...
    public static long GetSpecialTypeIdFromBean_Item(Zeze.Transaction.Bean bean) {
        ...
        throw new RuntimeException("Unknown Bean! dynamic@Zeze.Beans.Game.Bag.BItem:Item");
    }
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Bag.BItem: {").append(System.lineSeparator());
        level += 4;
