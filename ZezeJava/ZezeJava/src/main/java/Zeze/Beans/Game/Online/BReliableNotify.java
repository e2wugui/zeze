...
public final class BReliableNotify extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -3497603379828718764L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Online.BReliableNotify: {").append(System.lineSeparator());
        level += 4;
