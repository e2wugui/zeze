...
public final class BReLogin extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 4382577635312732963L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Online.BReLogin: {").append(System.lineSeparator());
        level += 4;
