...
public final class BOnline extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -4535176322560155628L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Game.Online.BOnline: {").append(System.lineSeparator());
        level += 4;
