...
public final class Value extends Zeze.Raft.RocksRaft.Bean {
    ...
    private final Zeze.Raft.RocksRaft.CollSet1<Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey> _SetBeankey;
    private final Zeze.Raft.RocksRaft.CollMap1<Integer, Integer> _MapInt;
    private final Zeze.Raft.RocksRaft.CollMap2<Integer, Zeze.Beans.TestRocks.Value> _MapBean;
    private Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey _Beankey;
    ...
    public Zeze.Raft.RocksRaft.CollSet1<Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey> getSetBeankey() {
        return _SetBeankey;
    }
    ...
    public Zeze.Raft.RocksRaft.CollMap2<Integer, Zeze.Beans.TestRocks.Value> getMapBean() {
        return _MapBean;
    }

    @SuppressWarnings("unchecked")
    public Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey getBeankey() {
        if (!isManaged())
            return _Beankey;
        var txn = Zeze.Raft.RocksRaft.Transaction.getCurrent();
        if (txn == null)
        ...
        if (null == log)
            return _Beankey;
        return ((Zeze.Raft.RocksRaft.Log1.LogBeanKey<Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey>)log).Value;
    }

    public void setBeankey(Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey value) {
        if (value == null)
            throw new IllegalArgumentException();
        if (!isManaged()) {
            _Beankey = value;
        ...
        var txn = Zeze.Raft.RocksRaft.Transaction.getCurrent();
        assert txn != null;
        txn.PutLog(new Zeze.Raft.RocksRaft.Log1.LogBeanKey<>(Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey.class, this, 11, value));
    }
    ...
    public Value(int _varId_) {
        ...
        _SetBeankey = new Zeze.Raft.RocksRaft.CollSet1<>(Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey.class);
        _SetBeankey.VariableId = 8;
        _MapInt = new Zeze.Raft.RocksRaft.CollMap1<>(Integer.class, Integer.class);
        _MapInt.VariableId = 9;
        _MapBean = new Zeze.Raft.RocksRaft.CollMap2<>(Integer.class, Zeze.Beans.TestRocks.Value.class);
    ...
    public static final long TYPEID = 4775088191372579691L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.TestRocks.Value: {").append(System.lineSeparator());
        level += 4;
    ...
    public void LeaderApplyNoRecursive(Zeze.Raft.RocksRaft.Log vlog) {
        switch (vlog.getVariableId()) {
            ...
            case 11: _Beankey = ((Zeze.Raft.RocksRaft.Log1.LogBeanKey<Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey>)vlog).Value; break;
        }
    }
