...
public final class BModuleRedirectAllResult extends Zeze.Transaction.Bean {
    ...
    private final Zeze.Transaction.Collections.PMap2<Integer, Zeze.Beans.Provider.BModuleRedirectAllHash> _Hashs; // 发送给具体进程时需要处理的分组hash-index（目前由linkd填写）
    ...
    public Zeze.Transaction.Collections.PMap2<Integer, Zeze.Beans.Provider.BModuleRedirectAllHash> getHashs() {
        return _Hashs;
    }
    ...
    public static final long TYPEID = -3418085454110567175L;
    ...
    private static final class Log__Hashs extends Zeze.Transaction.Collections.PMap.LogV<Integer, Zeze.Beans.Provider.BModuleRedirectAllHash> {
        public Log__Hashs(BModuleRedirectAllResult host, org.pcollections.PMap<Integer, Zeze.Beans.Provider.BModuleRedirectAllHash> value) { super(host, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BModuleRedirectAllResult: {").append(System.lineSeparator());
        level += 4;
        ...
        if (_i_ == 6) {
            ...
            if ((_t_ & ByteBuffer.TAG_MASK) == ByteBuffer.MAP) {
                ...
                for (int _n_ = _o_.ReadUInt(); _n_ > 0; _n_--) {
                    ...
                    var _v_ = _o_.ReadBean(new Zeze.Beans.Provider.BModuleRedirectAllHash(), _t_);
                    _x_.put(_k_, _v_);
                }
            } else
