...
public final class BModuleRedirectAllHash extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -2280819963351224776L;
    ...
    private static final class Log__Actions extends Zeze.Transaction.Collections.PList.LogV<Zeze.Beans.Provider.BActionParam> {
        public Log__Actions(BModuleRedirectAllHash host, org.pcollections.PVector<Zeze.Beans.Provider.BActionParam> value) { super(host, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BModuleRedirectAllHash: {").append(System.lineSeparator());
        level += 4;
