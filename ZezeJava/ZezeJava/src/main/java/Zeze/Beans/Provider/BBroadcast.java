...
public final class BBroadcast extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -5381793367592715266L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BBroadcast: {").append(System.lineSeparator());
        level += 4;
