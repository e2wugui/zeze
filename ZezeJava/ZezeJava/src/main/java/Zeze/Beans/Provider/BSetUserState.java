...
public final class BSetUserState extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 8189085298092274317L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BSetUserState: {").append(System.lineSeparator());
        level += 4;
