...
public final class BDispatch extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -5906956254815381209L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BDispatch: {").append(System.lineSeparator());
        level += 4;
