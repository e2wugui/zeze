...
public final class BActionParam extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 3711831484077633400L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BActionParam: {").append(System.lineSeparator());
        level += 4;
