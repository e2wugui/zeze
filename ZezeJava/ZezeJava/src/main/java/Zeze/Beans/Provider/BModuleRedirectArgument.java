...
public final class BModuleRedirectArgument extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 3680052566161167308L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BModuleRedirectArgument: {").append(System.lineSeparator());
        level += 4;
