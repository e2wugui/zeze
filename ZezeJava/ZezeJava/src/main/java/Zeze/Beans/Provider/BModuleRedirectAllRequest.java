...
public final class BModuleRedirectAllRequest extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 5448329682915116443L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BModuleRedirectAllRequest: {").append(System.lineSeparator());
        level += 4;
