...
public final class BTransmitContext extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -3062272109929467984L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BTransmitContext: {").append(System.lineSeparator());
        level += 4;
