...
public final class BTransmit extends Zeze.Transaction.Bean {
    ...
    private final Zeze.Transaction.Collections.PMap2<Long, Zeze.Beans.Provider.BTransmitContext> _Roles; // 查询目标角色。
    ...
    public Zeze.Transaction.Collections.PMap2<Long, Zeze.Beans.Provider.BTransmitContext> getRoles() {
        return _Roles;
    }
    ...
    public static final long TYPEID = 8697700940337216241L;
    ...
    private static final class Log__Roles extends Zeze.Transaction.Collections.PMap.LogV<Long, Zeze.Beans.Provider.BTransmitContext> {
        public Log__Roles(BTransmit host, org.pcollections.PMap<Long, Zeze.Beans.Provider.BTransmitContext> value) { super(host, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BTransmit: {").append(System.lineSeparator());
        level += 4;
        ...
        if (_i_ == 2) {
            ...
            if ((_t_ & ByteBuffer.TAG_MASK) == ByteBuffer.MAP) {
                ...
                for (int _n_ = _o_.ReadUInt(); _n_ > 0; _n_--) {
                    ...
                    var _v_ = _o_.ReadBean(new Zeze.Beans.Provider.BTransmitContext(), _t_);
                    _x_.put(_k_, _v_);
                }
            } else
