...
public final class BTaskId extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 2338818161665672403L;
    ...
    private static final class Log__TaskId extends Zeze.Transaction.Log1<BTaskId, Long> {
        public Log__TaskId(BTaskId self, Long value) { super(self, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.RedoQueue.BTaskId: {").append(System.lineSeparator());
        level += 4;
