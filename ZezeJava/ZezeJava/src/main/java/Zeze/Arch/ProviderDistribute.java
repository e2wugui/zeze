...
public class ProviderDistribute extends AbstractProviderDistribute {
    ...
    @Override
    protected long ProcessModuleRedirectRequest(Zeze.Beans.Provider.ModuleRedirect r) {
        return Zeze.Transaction.Procedure.NotImplement;
    }

    @Override
    protected long ProcessModuleRedirectAllRequest(Zeze.Beans.Provider.ModuleRedirectAllRequest p) {
        return Zeze.Transaction.Procedure.NotImplement;
    }
    ...
    @Override
    protected long ProcessTransmit(Zeze.Beans.Provider.Transmit p) {
        return Zeze.Transaction.Procedure.NotImplement;
    }
