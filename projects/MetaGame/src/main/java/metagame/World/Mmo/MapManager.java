...
import metagame.builtin.World.BEnterConfirm;
import metagame.builtin.World.BEnterWorld;
import metagame.builtin.World.BLoad;
import metagame.builtin.World.BLoadMap;
import metagame.builtin.World.Command;
import metagame.builtin.World.Static.BSwitchWorld;
import Zeze.Component.AutoKey;
import Zeze.Services.ServiceManager.BSubscribeInfo;
import Zeze.Transaction.Procedure;
import metagame.World.CubeMap;
import metagame.World.Entity;
import metagame.World.ICommand;
import metagame.World.IMapManager;
import metagame.World.LockGuard;
...
public class MapManager implements IMapManager, ICommand {
	...
	public MapManager(World world) {
		this.autoKeyMap = world.providerApp.zeze.getAutoKey("metagame.World.AutoKeyMap");
		this.autoKeyEntity = world.providerApp.zeze.getAutoKey("metagame.World.AutoKeyEntity");
		this.world = world;
