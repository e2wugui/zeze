...
public final class BAoiLeaves extends Zeze.Transaction.Bean implements BAoiLeavesReadOnly {
    public static final long TYPEID = -2399653502732429866L;
    ...
    @Override
    public metagame.builtin.World.BAoiLeaves.Data toData() {
        var _d_ = new metagame.builtin.World.BAoiLeaves.Data();
        _d_.assign(this);
        return _d_;
    }
    ...
    public void assign(Zeze.Transaction.Data _o_) {
        assign((metagame.builtin.World.BAoiLeaves.Data)_o_);
    }

    public void assign(BAoiLeaves.Data _o_) {
        _Keys.clear();
        _Keys.addAll(_o_._Keys);
        _unknown_ = null;
    }

    public void assign(BAoiLeaves _o_) {
    ...
    public BAoiLeaves copy() {
        var _c_ = new BAoiLeaves();
        _c_.assign(this);
        return _c_;
    }

    public static void swap(BAoiLeaves _a_, BAoiLeaves _b_) {
        var _s_ = _a_.copy();
        _a_.assign(_b_);
        _b_.assign(_s_);
    }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("metagame.builtin.World.BAoiLeaves: {\n");
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BAoiLeaves))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BAoiLeaves)_o_;
    ...
    public void decodeResultSet(java.util.ArrayList<String> _p_, java.sql.ResultSet _r_) throws java.sql.SQLException {
        ...
        Zeze.Serialize.Helper.decodeJsonList(_Keys, Long.class, _r_.getString(_pn_ + "Keys"));
    }
    ...
    public java.util.ArrayList<Zeze.Builtin.HotDistribute.BVariable.Data> variables() {
        ...
        _v_.add(new Zeze.Builtin.HotDistribute.BVariable.Data(1, "Keys", "list", "", "long"));
        return _v_;
    }
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    public void setKeys(java.util.ArrayList<Long> _v_) {
        if (_v_ == null)
    ...
    @Override
    public metagame.builtin.World.BAoiLeaves toBean() {
        var _b_ = new metagame.builtin.World.BAoiLeaves();
        _b_.assign(this);
        return _b_;
    }
    ...
    public BAoiLeaves.Data copy() {
        var _c_ = new BAoiLeaves.Data();
        _c_.assign(this);
        return _c_;
    }

    public static void swap(BAoiLeaves.Data _a_, BAoiLeaves.Data _b_) {
        var _s_ = _a_.copy();
        _a_.assign(_b_);
        _b_.assign(_s_);
    }
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BAoiLeaves.Data))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BAoiLeaves.Data)_o_;
        if (!_Keys.equals(_b_._Keys))
            return false;
        return true;
    }
