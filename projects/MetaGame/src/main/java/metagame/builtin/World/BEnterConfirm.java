...
public final class BEnterConfirm extends Zeze.Transaction.Bean implements BEnterConfirmReadOnly {
    public static final long TYPEID = 648889173444053339L;
    ...
    static {
        ...
        try {
            vh_MapInstanceId = _l_.findVarHandle(BEnterConfirm.class, "_MapInstanceId", long.class);
    ...
    @Override
    public metagame.builtin.World.BEnterConfirm.Data toData() {
        var _d_ = new metagame.builtin.World.BEnterConfirm.Data();
        _d_.assign(this);
        return _d_;
    }
    ...
    public void assign(Zeze.Transaction.Data _o_) {
        assign((metagame.builtin.World.BEnterConfirm.Data)_o_);
    }

    public void assign(BEnterConfirm.Data _o_) {
        setMapInstanceId(_o_._MapInstanceId);
        _unknown_ = null;
    }

    public void assign(BEnterConfirm _o_) {
    ...
    public BEnterConfirm copy() {
        var _c_ = new BEnterConfirm();
        _c_.assign(this);
        return _c_;
    }

    public static void swap(BEnterConfirm _a_, BEnterConfirm _b_) {
        var _s_ = _a_.copy();
        _a_.assign(_b_);
        _b_.assign(_s_);
    }
    ...
    public void buildString(StringBuilder _s_, int _l_) {
        ...
        _s_.append("metagame.builtin.World.BEnterConfirm: {\n");
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BEnterConfirm))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BEnterConfirm)_o_;
...
public static final class Data extends Zeze.Transaction.Data {
    ...
    @Override
    public metagame.builtin.World.BEnterConfirm toBean() {
        var _b_ = new metagame.builtin.World.BEnterConfirm();
        _b_.assign(this);
        return _b_;
    }
    ...
    public BEnterConfirm.Data copy() {
        var _c_ = new BEnterConfirm.Data();
        _c_.assign(this);
        return _c_;
    }

    public static void swap(BEnterConfirm.Data _a_, BEnterConfirm.Data _b_) {
        var _s_ = _a_.copy();
        _a_.assign(_b_);
        _b_.assign(_s_);
    }
    ...
    public boolean equals(Object _o_) {
        if (_o_ == this)
            return true;
        if (!(_o_ instanceof BEnterConfirm.Data))
            return false;
        //noinspection PatternVariableCanBeUsed
        var _b_ = (BEnterConfirm.Data)_o_;
