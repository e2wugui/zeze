...
获取 https://gitee.com/e2wugui/zeze/tree/master/ZezeJava/scripts/cue 这个目录，在此目录下
...
- zeze.cue 是总览，生成dashboard如下
  
  ![dashboard brief](./dashboard_brief.png)

- zeze_detail.cue是详细信息，生成dashboard如下
