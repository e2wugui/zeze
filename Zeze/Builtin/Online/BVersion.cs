    ...
    public sealed class BVersion : Zeze.Transaction.Bean, BVersionReadOnly
    {
        ...
        public long ReliableNotifyTotalCount
        {
            get
            {
                ...
                txn.VerifyRecordAccessed(this, true);
                var log = (Log__ReliableNotifyTotalCount)txn.GetLog(ObjectId + 4);
            ...
            set
            {
                ...
                var txn = Zeze.Transaction.Transaction.Current;
                txn.VerifyRecordAccessed(this);
                txn.PutLog(new Log__ReliableNotifyTotalCount() { Belong = this, VariableId = 4, Value = value });
            }
        }
        ...
        public long ReliableNotifyConfirmCount
        {
            get
            {
                ...
                txn.VerifyRecordAccessed(this, true);
                var log = (Log__ReliableNotifyConfirmCount)txn.GetLog(ObjectId + 5);
            ...
            set
            {
                ...
                var txn = Zeze.Transaction.Transaction.Current;
                txn.VerifyRecordAccessed(this);
                txn.PutLog(new Log__ReliableNotifyConfirmCount() { Belong = this, VariableId = 5, Value = value });
            }
        }
        ...
        public override void FollowerApply(Zeze.Transaction.Log log)
        {
            ...
            foreach (var vlog in blog.Variables.Values)
            {
                switch (vlog.VariableId)
                {
                    ...
                    case 4: _ReliableNotifyTotalCount = ((Zeze.Transaction.Log<long>)vlog).Value; break;
                    case 5: _ReliableNotifyConfirmCount = ((Zeze.Transaction.Log<long>)vlog).Value; break;
