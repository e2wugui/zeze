...
namespace Zeze.Builtin.Online
{
    ...
    {
        readonly Zeze.Transaction.Collections.PMap2<string, Zeze.Builtin.Online.BLocal> _Logins; // key is ClientId
        Zeze.Transaction.Collections.PMapReadOnly<string,Zeze.Builtin.Online.BLocalReadOnly,Zeze.Builtin.Online.BLocal> _LoginsReadOnly;

        public Zeze.Transaction.Collections.PMap2<string, Zeze.Builtin.Online.BLocal> Logins => _Logins;
        ...
        {
            _Logins = new Zeze.Transaction.Collections.PMap2<string, Zeze.Builtin.Online.BLocal>(ObjectId + 1, _v => new Log__Logins(this, _v));
            _LoginsReadOnly = new Zeze.Transaction.Collections.PMapReadOnly<string,Zeze.Builtin.Online.BLocalReadOnly,Zeze.Builtin.Online.BLocal>(_Logins);
        }
        ...
        sealed class Log__Logins : Zeze.Transaction.Collections.PMap2<string, Zeze.Builtin.Online.BLocal>.LogV
        {
            public Log__Logins(BLocals host, System.Collections.Immutable.ImmutableDictionary<string, Zeze.Builtin.Online.BLocal> value) : base(host, value) {}
            public override long LogKey => Belong.ObjectId + 1;
            public BLocals BeanTyped => (BLocals)Belong;
