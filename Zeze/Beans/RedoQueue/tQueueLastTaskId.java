...
public final class tQueueLastTaskId extends Zeze.Transaction.TableX<String, Zeze.Beans.RedoQueue.BTaskId> {
    public tQueueLastTaskId() {
        super("Zeze_Beans_RedoQueue_tQueueLastTaskId");
    }
    ...
    @Override
    public Zeze.Beans.RedoQueue.BTaskId NewValue() {
        return new Zeze.Beans.RedoQueue.BTaskId();
    }
