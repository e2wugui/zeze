...
public final class BQueueTask extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -948485694888722793L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.RedoQueue.BQueueTask: {").append(System.lineSeparator());
        level += 4;
