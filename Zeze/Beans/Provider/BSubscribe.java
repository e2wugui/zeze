...
public final class BSubscribe extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 2656884454581508565L;
    ...
    private static final class Log__modules extends Zeze.Transaction.Collections.PMap.LogV<Integer, Zeze.Beans.Provider.BModule> {
        public Log__modules(BSubscribe host, org.pcollections.PMap<Integer, Zeze.Beans.Provider.BModule> value) { super(host, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BSubscribe: {").append(System.lineSeparator());
        level += 4;
