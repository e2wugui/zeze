...
namespace Zeze.Beans.Provider
{
    ...
    public sealed class BSubscribe : Zeze.Transaction.Bean, BSubscribeReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlyDictionary<int,Zeze.Beans.Provider.BModuleReadOnly> Zeze.Beans.Provider.BSubscribeReadOnly.Modules => _modulesReadOnly;
        ...
        public const long TYPEID = 2656884454581508565;
        public override long TypeId => TYPEID;

        sealed class Log__modules : Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.Provider.BModule>.LogV
        {
            public Log__modules(BSubscribe host, System.Collections.Immutable.ImmutableDictionary<int, Zeze.Beans.Provider.BModule> value) : base(host, value) {}
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Provider.BSubscribe: {").Append(Environment.NewLine);
            level += 4;
