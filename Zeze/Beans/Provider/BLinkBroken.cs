...
namespace Zeze.Beans.Provider
{
    ...
    public sealed class BLinkBroken : Zeze.Transaction.Bean, BLinkBrokenReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlyList<long> Zeze.Beans.Provider.BLinkBrokenReadOnly.States => _states;
        ...
        public const long TYPEID = -2744074986569701166;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Provider.BLinkBroken: {").Append(Environment.NewLine);
            level += 4;
