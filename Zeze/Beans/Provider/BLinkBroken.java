...
public final class BLinkBroken extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -2744074986569701166L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BLinkBroken: {").append(System.lineSeparator());
        level += 4;
