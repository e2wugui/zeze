...
namespace Zeze.Beans.Provider
{
    ...
    public sealed class BAnnounceProviderInfo : Zeze.Transaction.Bean, BAnnounceProviderInfoReadOnly
    {
        ...
        public const long TYPEID = -4949917838498057735;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Provider.BAnnounceProviderInfo: {").Append(Environment.NewLine);
            level += 4;
