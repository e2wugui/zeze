...
namespace Zeze.Beans.Provider
{
    ...
    public sealed class BDispatch : Zeze.Transaction.Bean, BDispatchReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlyList<long> Zeze.Beans.Provider.BDispatchReadOnly.States => _states;
        ...
        public const long TYPEID = -5906956254815381209;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Provider.BDispatch: {").Append(Environment.NewLine);
            level += 4;
