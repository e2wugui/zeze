...
public final class BAnnounceLinkInfo extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = -7068079009435311792L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.Provider.BAnnounceLinkInfo: {").append(System.lineSeparator());
        level += 4;
