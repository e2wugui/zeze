...
public final class BAutoKey extends Zeze.Transaction.Bean {
    ...
    public static final long TYPEID = 2472086442556797482L;
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(Zeze.Util.Str.indent(level)).append("Zeze.Beans.AutoKey.BAutoKey: {").append(System.lineSeparator());
        level += 4;
