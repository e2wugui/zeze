...
namespace Zeze.Beans.DelayRemove
{
    ...
    public sealed class BTableKey : Zeze.Transaction.Bean, BTableKeyReadOnly
    {
        ...
        public const long TYPEID = -6901367835273718674;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.DelayRemove.BTableKey: {").Append(Environment.NewLine);
            level += 4;
