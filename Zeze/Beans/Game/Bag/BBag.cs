...
namespace Zeze.Beans.Game.Bag
{
    public interface BBagReadOnly
    {
        ...
        public System.Collections.Generic.IReadOnlyDictionary<int,Zeze.Beans.Game.Bag.BItemReadOnly> Items { get; }
    }

    public sealed class BBag : Zeze.Transaction.Bean, BBagReadOnly
    {
        int _Capacity;
        readonly Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.Game.Bag.BItem> _Items; // key is bag position
        Zeze.Transaction.Collections.PMapReadOnly<int,Zeze.Beans.Game.Bag.BItemReadOnly,Zeze.Beans.Game.Bag.BItem> _ItemsReadOnly;
        ...
        public Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.Game.Bag.BItem> Items => _Items;
        System.Collections.Generic.IReadOnlyDictionary<int,Zeze.Beans.Game.Bag.BItemReadOnly> Zeze.Beans.Game.Bag.BBagReadOnly.Items => _ItemsReadOnly;
        ...
        {
            _Items = new Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.Game.Bag.BItem>(ObjectId + 2, _v => new Log__Items(this, _v));
            _ItemsReadOnly = new Zeze.Transaction.Collections.PMapReadOnly<int,Zeze.Beans.Game.Bag.BItemReadOnly,Zeze.Beans.Game.Bag.BItem>(_Items);
        }
        ...
        public const long TYPEID = 2844494039708458018;
        ...
        sealed class Log__Items : Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.Game.Bag.BItem>.LogV
        {
            public Log__Items(BBag host, System.Collections.Immutable.ImmutableDictionary<int, Zeze.Beans.Game.Bag.BItem> value) : base(host, value) {}
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Bag.BBag: {").Append(Environment.NewLine);
            level += 4;
