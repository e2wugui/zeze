...
namespace Zeze.Beans.Game.Bag
{
    ...
    public sealed class BItem : Zeze.Transaction.Bean, BItemReadOnly
    {
        ...
        Zeze.Transaction.DynamicBeanReadOnly Zeze.Beans.Game.Bag.BItemReadOnly.Item => Item;
        ...
        public const long TYPEID = 3472511193920401251;
        ...
        public static long GetSpecialTypeIdFromBean_Item(Zeze.Transaction.Bean bean)
        {
            ...
            throw new System.Exception("Unknown Bean! dynamic@Zeze.Beans.Game.Bag.BItem:Item");
        }
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Bag.BItem: {").Append(Environment.NewLine);
            level += 4;
