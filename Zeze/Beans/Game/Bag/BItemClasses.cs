...
namespace Zeze.Beans.Game.Bag
{
    ...
    public sealed class BItemClasses : Zeze.Transaction.Bean, BItemClassesReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlySet<string> Zeze.Beans.Game.Bag.BItemClassesReadOnly.ItemClasses => _ItemClasses;
        ...
        public const long TYPEID = 7263821517053449735;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Bag.BItemClasses: {").Append(Environment.NewLine);
            level += 4;
