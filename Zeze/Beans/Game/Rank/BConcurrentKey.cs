...
namespace Zeze.Beans.Game.Rank
{
    public sealed class BConcurrentKey : Serializable, System.IComparable
    {
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Rank.BConcurrentKey: {").Append(Environment.NewLine);
            level += 4;
        ...
        public int CompareTo(object _o1_)
        {
            ...
            throw new Exception("CompareTo: another object is not Zeze.Beans.Game.Rank.BConcurrentKey");
        }
