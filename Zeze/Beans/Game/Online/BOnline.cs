...
namespace Zeze.Beans.Game.Online
{
    ...
    public sealed class BOnline : Zeze.Transaction.Bean, BOnlineReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlySet<string> Zeze.Beans.Game.Online.BOnlineReadOnly.ReliableNotifyMark => _ReliableNotifyMark;

        public Zeze.Transaction.Collections.PList1<Zeze.Net.Binary> ReliableNotifyQueue => _ReliableNotifyQueue;
        System.Collections.Generic.IReadOnlyList<Zeze.Net.Binary> Zeze.Beans.Game.Online.BOnlineReadOnly.ReliableNotifyQueue => _ReliableNotifyQueue;
        ...
        public const long TYPEID = -4535176322560155628;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Online.BOnline: {").Append(Environment.NewLine);
            level += 4;
