...
{
    public sealed class ReliableNotifyConfirm : Zeze.Net.Rpc<Zeze.Beans.Game.Online.BReliableNotifyConfirm, Zeze.Transaction.EmptyBean>
    {
        public const int ModuleId_ = 11013;
        public const int ProtocolId_ = -1455146603;
