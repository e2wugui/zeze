...
namespace Zeze.Beans.Game.Online
{
    ...
    public sealed class BReliableNotify : Zeze.Transaction.Bean, BReliableNotifyReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlyList<Zeze.Net.Binary> Zeze.Beans.Game.Online.BReliableNotifyReadOnly.Notifies => _Notifies;
        ...
        public const long TYPEID = -3497603379828718764;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Online.BReliableNotify: {").Append(Environment.NewLine);
            level += 4;
