...
namespace Zeze.Beans.Game.Online
{
    ...
    public sealed class BReliableNotifyConfirm : Zeze.Transaction.Bean, BReliableNotifyConfirmReadOnly
    {
        ...
        public const long TYPEID = 4003270441446701916;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Online.BReliableNotifyConfirm: {").Append(Environment.NewLine);
            level += 4;
