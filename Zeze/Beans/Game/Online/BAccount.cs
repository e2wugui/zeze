...
namespace Zeze.Beans.Game.Online
{
    ...
    public sealed class BAccount : Zeze.Transaction.Bean, BAccountReadOnly
    {
        ...
        System.Collections.Generic.IReadOnlyList<long> Zeze.Beans.Game.Online.BAccountReadOnly.Roles => _Roles;
        ...
        public const long TYPEID = 8206234522906707244;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Game.Online.BAccount: {").Append(Environment.NewLine);
            level += 4;
