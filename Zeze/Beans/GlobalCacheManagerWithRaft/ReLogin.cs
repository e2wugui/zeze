...
{
    public sealed class ReLogin : Zeze.Raft.RaftRpc<Zeze.Beans.GlobalCacheManagerWithRaft.LoginParam, Zeze.Transaction.EmptyBean>
    {
        public const int ModuleId_ = 11001;
        public const int ProtocolId_ = -1568199819;
