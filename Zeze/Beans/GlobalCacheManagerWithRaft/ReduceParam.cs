...
namespace Zeze.Beans.GlobalCacheManagerWithRaft
{
    ...
    public sealed class ReduceParam : Zeze.Transaction.Bean, ReduceParamReadOnly
    {
        ...
        public const long TYPEID = -5927738941172057956;
        public override long TypeId => TYPEID;

        sealed class Log__GlobalTableKey : Zeze.Transaction.Log<ReduceParam, Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey>
        {
            public Log__GlobalTableKey(ReduceParam self, Zeze.Beans.GlobalCacheManagerWithRaft.GlobalTableKey value) : base(self, value) {}
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.GlobalCacheManagerWithRaft.ReduceParam: {").Append(Environment.NewLine);
            level += 4;
