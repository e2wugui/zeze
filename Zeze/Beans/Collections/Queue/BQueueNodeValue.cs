...
namespace Zeze.Beans.Collections.Queue
{
    ...
    public sealed class BQueueNodeValue : Zeze.Transaction.Bean, BQueueNodeValueReadOnly
    {
        ...
        Zeze.Transaction.DynamicBeanReadOnly Zeze.Beans.Collections.Queue.BQueueNodeValueReadOnly.Value => Value;
        ...
        public const long TYPEID = -6161354661761538624;
        ...
        public static long GetSpecialTypeIdFromBean_Value(Zeze.Transaction.Bean bean)
        {
            ...
            throw new System.Exception("Unknown Bean! dynamic@Zeze.Beans.Collections.Queue.BQueueNodeValue:Value");
        }
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Collections.Queue.BQueueNodeValue: {").Append(Environment.NewLine);
            level += 4;
