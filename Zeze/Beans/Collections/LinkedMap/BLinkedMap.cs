...
namespace Zeze.Beans.Collections.LinkedMap
{
    ...
    public sealed class BLinkedMap : Zeze.Transaction.Bean, BLinkedMapReadOnly
    {
        ...
        public const long TYPEID = -3967858046935728431;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Collections.LinkedMap.BLinkedMap: {").Append(Environment.NewLine);
            level += 4;
