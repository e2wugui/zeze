...
namespace Zeze.Beans.Collections.LinkedMap
{
    ...
    public sealed class BLinkedMapNodeId : Zeze.Transaction.Bean, BLinkedMapNodeIdReadOnly
    {
        ...
        public const long TYPEID = -7862041652063992716;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeId: {").Append(Environment.NewLine);
            level += 4;
