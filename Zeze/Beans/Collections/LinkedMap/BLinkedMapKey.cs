...
{
    public sealed class BLinkedMapKey : Serializable, System.IComparable
    {
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Collections.LinkedMap.BLinkedMapKey: {").Append(Environment.NewLine);
            level += 4;
        ...
        public int CompareTo(object _o1_)
        {
            ...
            throw new Exception("CompareTo: another object is not Zeze.Beans.Collections.LinkedMap.BLinkedMapKey");
        }
