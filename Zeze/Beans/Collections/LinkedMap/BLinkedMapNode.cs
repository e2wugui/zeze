...
namespace Zeze.Beans.Collections.LinkedMap
{
    public interface BLinkedMapNodeReadOnly
    {
        ...
        public System.Collections.Generic.IReadOnlyList<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValueReadOnly>Values { get; }
    }
    ...
    public sealed class BLinkedMapNode : Zeze.Transaction.Bean, BLinkedMapNodeReadOnly
    {
        ...
        readonly Zeze.Transaction.Collections.PList2<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValue> _Values; // 多个KeyValue对,容量由LinkedMap构造时的nodeSize决定
        ...
        public Zeze.Transaction.Collections.PList2<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValue> Values => _Values;
        System.Collections.Generic.IReadOnlyList<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValueReadOnly> Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeReadOnly.Values => _Values;
        ...
        {
            _Values = new Zeze.Transaction.Collections.PList2<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValue>(ObjectId + 3, _v => new Log__Values(this, _v));
        }
        ...
        public const long TYPEID = 7820337963104524751;
        ...
        sealed class Log__Values : Zeze.Transaction.Collections.PList2<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValue>.LogV
        {
            public Log__Values(BLinkedMapNode host, System.Collections.Immutable.ImmutableList<Zeze.Beans.Collections.LinkedMap.BLinkedMapNodeValue> value) : base(host, value) {}
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.Collections.LinkedMap.BLinkedMapNode: {").Append(Environment.NewLine);
            level += 4;
