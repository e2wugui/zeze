...
namespace Zeze.Beans.ProviderDirect
{
    public interface BModuleRedirectAllResultReadOnly
    {
        ...
        public System.Collections.Generic.IReadOnlyDictionary<int,Zeze.Beans.ProviderDirect.BModuleRedirectAllHashReadOnly> Hashs { get; }
    }
    ...
    public sealed class BModuleRedirectAllResult : Zeze.Transaction.Bean, BModuleRedirectAllResultReadOnly
    {
        ...
        readonly Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.ProviderDirect.BModuleRedirectAllHash> _Hashs; // 发送给具体进程时需要处理的分组hash-index（目前由linkd填写）
        Zeze.Transaction.Collections.PMapReadOnly<int,Zeze.Beans.ProviderDirect.BModuleRedirectAllHashReadOnly,Zeze.Beans.ProviderDirect.BModuleRedirectAllHash> _HashsReadOnly;
        ...
        public Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.ProviderDirect.BModuleRedirectAllHash> Hashs => _Hashs;
        System.Collections.Generic.IReadOnlyDictionary<int,Zeze.Beans.ProviderDirect.BModuleRedirectAllHashReadOnly> Zeze.Beans.ProviderDirect.BModuleRedirectAllResultReadOnly.Hashs => _HashsReadOnly;
        ...
        {
            _MethodFullName = "";
            _Hashs = new Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.ProviderDirect.BModuleRedirectAllHash>(ObjectId + 6, _v => new Log__Hashs(this, _v));
            _HashsReadOnly = new Zeze.Transaction.Collections.PMapReadOnly<int,Zeze.Beans.ProviderDirect.BModuleRedirectAllHashReadOnly,Zeze.Beans.ProviderDirect.BModuleRedirectAllHash>(_Hashs);
        }
        ...
        public const long TYPEID = 5876256023621191026;
        ...
        sealed class Log__Hashs : Zeze.Transaction.Collections.PMap2<int, Zeze.Beans.ProviderDirect.BModuleRedirectAllHash>.LogV
        {
            public Log__Hashs(BModuleRedirectAllResult host, System.Collections.Immutable.ImmutableDictionary<int, Zeze.Beans.ProviderDirect.BModuleRedirectAllHash> value) : base(host, value) {}
            public override long LogKey => Bean.ObjectId + 6;
            public BModuleRedirectAllResult BeanTyped => (BModuleRedirectAllResult)Bean;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.ProviderDirect.BModuleRedirectAllResult: {").Append(Environment.NewLine);
            level += 4;
            ...
            if (_i_ == 6)
            {
                ...
                if ((_t_ & ByteBuffer.TAG_MASK) == ByteBuffer.MAP)
                {
                    ...
                    for (int _n_ = _o_.ReadUInt(); _n_ > 0; _n_--)
                    {
                        ...
                        var _v_ = _o_.ReadBean(new Zeze.Beans.ProviderDirect.BModuleRedirectAllHash(), _t_);
                        _x_.Add(_k_, _v_);
                    }
                }
                else
