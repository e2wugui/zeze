...
namespace Zeze.Beans.ProviderDirect
{
    ...
    public sealed class BModuleRedirectArgument : Zeze.Transaction.Bean, BModuleRedirectArgumentReadOnly
    {
        ...
        public BModuleRedirectArgument() : this(0)
        {
        }

        public BModuleRedirectArgument(int _varId_) : base(_varId_)
        {
            _MethodFullName = "";
        ...
        public const long TYPEID = -6999279897017654685;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.ProviderDirect.BModuleRedirectArgument: {").Append(Environment.NewLine);
            level += 4;
