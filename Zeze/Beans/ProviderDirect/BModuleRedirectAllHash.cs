...
namespace Zeze.Beans.ProviderDirect
{
    ...
    public sealed class BModuleRedirectAllHash : Zeze.Transaction.Bean, BModuleRedirectAllHashReadOnly
    {
        ...
        public const long TYPEID = 154626821827676561;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.ProviderDirect.BModuleRedirectAllHash: {").Append(Environment.NewLine);
            level += 4;
