...
namespace Zeze.Beans.ProviderDirect
{
    ...
    public sealed class BTransmitContext : Zeze.Transaction.Bean, BTransmitContextReadOnly
    {
        ...
        public const long TYPEID = 3228790106052223913;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.ProviderDirect.BTransmitContext: {").Append(Environment.NewLine);
            level += 4;
