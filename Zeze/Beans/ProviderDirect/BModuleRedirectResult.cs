...
namespace Zeze.Beans.ProviderDirect
{
    ...
    public sealed class BModuleRedirectResult : Zeze.Transaction.Bean, BModuleRedirectResultReadOnly
    {
        ...
        public const long TYPEID = -7733542558551497149;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zeze.Beans.ProviderDirect.BModuleRedirectResult: {").Append(Environment.NewLine);
            level += 4;
