...
{
    [System.Serializable]
    public sealed class BDepartmentNodeId : Zeze.Util.ConfBean
    {
        public string Group;
        public long DepartmentId;
        public long NodeId;

        public BDepartmentNodeId()
        {
            Group = "";
        }

        public const long TYPEID = 5039430879036856563;
        public override long TypeId => 5039430879036856563;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zege.Friend.BDepartmentNodeId: {").Append(Environment.NewLine);
            level += 4;
        ...
        public override void FollowerApply(Zeze.Transaction.Log log)
        {
            ...
            foreach (var vlog in blog.Variables.Values)
            {
                switch (vlog.VariableId)
                {
                    ...
                    case 3: NodeId = ((Zeze.Transaction.Log<long>)vlog).Value; break;
                }
            }
        }
