...
{
    [System.Serializable]
    public sealed class BCreateDepartment : Zeze.Util.ConfBean
    {
        public string Group;
        public long DepartmentId;
        public string Name;

        public BCreateDepartment()
        {
            Group = "";
            Name = "";
        }

        public const long TYPEID = -1519886491516710508;
        public override long TypeId => -1519886491516710508;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zege.Friend.BCreateDepartment: {").Append(Environment.NewLine);
            level += 4;
