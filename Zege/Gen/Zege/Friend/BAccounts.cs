...
namespace Zege.Friend
{
    ...
    public sealed class BAccounts : Zeze.Util.ConfBean
    {
        ...
        public BAccounts()
        {
            Accounts = new System.Collections.Generic.List<string>();
        }

        public const long TYPEID = -2824644900641320868;
        public override long TypeId => -2824644900641320868;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zege.Friend.BAccounts: {").Append(Environment.NewLine);
            level += 4;
        ...
        public override void FollowerApply(Zeze.Transaction.Log log)
        {
            ...
            foreach (var vlog in blog.Variables.Values)
            {
                ...
                {
                    case 1: Zeze.Transaction.Collections.CollApply.ApplyList1(Accounts, vlog); break;
                }
            }
        }
