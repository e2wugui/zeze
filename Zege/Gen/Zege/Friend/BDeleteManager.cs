...
{
    [System.Serializable]
    public sealed class BDeleteManager : Zeze.Util.ConfBean
    {
        public string Group;
        public long DepartmentId;
        public string Account;

        public BDeleteManager()
        {
            Group = "";
            Account = "";
        }

        public const long TYPEID = -1920841678908444180;
        public override long TypeId => -1920841678908444180;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zege.Friend.BDeleteManager: {").Append(Environment.NewLine);
            level += 4;
