...
{
    [System.Serializable]
    public sealed class BGetFriendNode : Zeze.Util.ConfBean
    {
        ...
        public const long TYPEID = -925826109913901448;
        public override long TypeId => -925826109913901448;
        ...
        {
            sb.Append(Zeze.Util.Str.Indent(level)).Append("Zege.Friend.BGetFriendNode: {").Append(Environment.NewLine);
            level += 4;
