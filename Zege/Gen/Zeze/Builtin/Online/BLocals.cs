...
{
    [System.Serializable]
    public sealed class BLocals : Zeze.Util.ConfBean
    {
        public System.Collections.Generic.Dictionary<string, Zeze.Builtin.Online.BLocal> Logins; // key is ClientId

        public BLocals()
        {
            Logins = new System.Collections.Generic.Dictionary<string, Zeze.Builtin.Online.BLocal>();
        }

        public const long TYPEID = -3801167864121993305;
        public override long TypeId => -3801167864121993305;
