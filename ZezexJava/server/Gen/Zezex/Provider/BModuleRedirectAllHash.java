...
public final class BModuleRedirectAllHash extends Zeze.Transaction.Bean implements BModuleRedirectAllHashReadOnly {
    ...
    public final static long TYPEID = -199765025868288061L;
    ...
    private final static class Log__ReturnCode extends Zeze.Transaction.Log1<BModuleRedirectAllHash, Integer> {
        public Log__ReturnCode(BModuleRedirectAllHash self, Integer value) { super(self, value); }
        @Override
    ...
    private final static class Log__Params extends Zeze.Transaction.Log1<BModuleRedirectAllHash, Zeze.Net.Binary> {
    ...
    private final class Log__Actions extends Zeze.Transaction.Collections.PList.LogV<Zezex.Provider.BActionParam> {
        public Log__Actions(BModuleRedirectAllHash host, org.pcollections.PVector<Zezex.Provider.BActionParam> value) { super(host, value); }
        @Override
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(" ".repeat(level * 4)).append("Zezex.Provider.BModuleRedirectAllHash: {").append(System.lineSeparator());
        level++;
