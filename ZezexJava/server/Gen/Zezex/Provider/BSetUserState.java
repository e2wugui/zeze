...
public final class BSetUserState extends Zeze.Transaction.Bean implements BSetUserStateReadOnly {
    ...
    public final static long TYPEID = 1067080601247567282L;
    ...
    private final static class Log__linkSid extends Zeze.Transaction.Log1<BSetUserState, Long> {
    ...
    private final static class Log__statex extends Zeze.Transaction.Log1<BSetUserState, Zeze.Net.Binary> {
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(" ".repeat(level * 4)).append("Zezex.Provider.BSetUserState: {").append(System.lineSeparator());
        level++;
