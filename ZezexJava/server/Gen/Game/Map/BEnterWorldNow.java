...
public final class BEnterWorldNow extends Zeze.Transaction.Bean implements BEnterWorldNowReadOnly {
    ...
    public final static long TYPEID = 2861757223843224449L;
    ...
    private final static class Log__MapInstanceId extends Zeze.Transaction.Log1<BEnterWorldNow, Integer> {
        public Log__MapInstanceId(BEnterWorldNow self, Integer value) { super(self, value); }
        @Override
    ...
    private final static class Log__x extends Zeze.Transaction.Log1<BEnterWorldNow, Float> {
        public Log__x(BEnterWorldNow self, Float value) { super(self, value); }
        @Override
        public long getLogKey() { return this.getBean().getObjectId() + 2; }
        @Override
        public void Commit() { this.getBeanTyped()._x = this.getValue(); }
    }

    private final static class Log__y extends Zeze.Transaction.Log1<BEnterWorldNow, Float> {
        public Log__y(BEnterWorldNow self, Float value) { super(self, value); }
        @Override
        public long getLogKey() { return this.getBean().getObjectId() + 3; }
        @Override
        public void Commit() { this.getBeanTyped()._y = this.getValue(); }
    }

    private final static class Log__z extends Zeze.Transaction.Log1<BEnterWorldNow, Float> {
        public Log__z(BEnterWorldNow self, Float value) { super(self, value); }
        @Override
        public long getLogKey() { return this.getBean().getObjectId() + 4; }
        @Override
        public void Commit() { this.getBeanTyped()._z = this.getValue(); }
    }

    private final static class Log__ResouceId extends Zeze.Transaction.Log1<BEnterWorldNow, Integer> {
        public Log__ResouceId(BEnterWorldNow self, Integer value) { super(self, value); }
        @Override
        public long getLogKey() { return this.getBean().getObjectId() + 5; }
        @Override
        public void Commit() { this.getBeanTyped()._ResouceId = this.getValue(); }
    }
    ...
    public void BuildString(StringBuilder sb, int level) {
        sb.append(" ".repeat(level * 4)).append("Game.Map.BEnterWorldNow: {").append(System.lineSeparator());
        level++;
        sb.append(" ".repeat(level * 4)).append("MapInstanceId").append("=").append(getMapInstanceId()).append(",").append(System.lineSeparator());
        sb.append(" ".repeat(level * 4)).append("x").append("=").append(getX()).append(",").append(System.lineSeparator());
        sb.append(" ".repeat(level * 4)).append("y").append("=").append(getY()).append(",").append(System.lineSeparator());
        sb.append(" ".repeat(level * 4)).append("z").append("=").append(getZ()).append(",").append(System.lineSeparator());
        sb.append(" ".repeat(level * 4)).append("ResouceId").append("=").append(getResouceId()).append("").append(System.lineSeparator());
        sb.append("}");
    }
