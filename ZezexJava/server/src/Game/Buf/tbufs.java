...
public final class tbufs extends Zeze.Transaction.Table<Long, Game.Buf.BBufs> {
	public tbufs() {
	...
	public static final int VAR_Bufs = 1;
	...
	public Zeze.Transaction.ChangeVariableCollector CreateChangeVariableCollector(int variableId) {
		return switch (variableId) {
			...
			case 1 -> new Zeze.Transaction.ChangeVariableCollectorMap(() -> new Zeze.Transaction.ChangeNoteMap2<Integer, Game.Buf.BBuf>(null));
			default -> null;
		};
	}
