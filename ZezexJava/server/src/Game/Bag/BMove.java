...
public final class BMove extends Zeze.Transaction.Bean implements BMoveReadOnly {
	...
	public static final long TYPEID = -3340594790196747034;
	@Override
	public long getTypeId() {
		return TYPEID;
	}

	private final static class Log__PositionFrom extends Zeze.Transaction.Log<BMove, Integer> {
		public Log__PositionFrom(BMove self, int value) {
			super(self, value);
		}
		@Override
		...
		@Override
		public void Commit() {
			this.getBeanTyped()._PositionFrom = this.getValue();
		}
	}

	private final static class Log__PositionTo extends Zeze.Transaction.Log<BMove, Integer> {
		public Log__PositionTo(BMove self, int value) {
			super(self, value);
		}
		@Override
		public long getLogKey() {
		...
		@Override
		public void Commit() {
			this.getBeanTyped()._PositionTo = this.getValue();
		}
	}

	private final static class Log__number extends Zeze.Transaction.Log<BMove, Integer> {
		public Log__number(BMove self, int value) {
			super(self, value);
		}
		@Override
		public long getLogKey() {
	...
	public void BuildString(StringBuilder sb, int level) {
		sb.append(tangible.StringHelper.repeatChar(' ', level * 4)).Append("Game.Bag.BMove: {").Append(System.lineSeparator());
		level++;
		sb.append(tangible.StringHelper.repeatChar(' ', level * 4)).Append("PositionFrom").Append("=").Append(getPositionFrom()).Append(",").Append(System.lineSeparator());
		sb.append(tangible.StringHelper.repeatChar(' ', level * 4)).Append("PositionTo").Append("=").Append(getPositionTo()).Append(",").Append(System.lineSeparator());
