...
public final class BModule extends Zeze.Transaction.Bean implements BModuleReadOnly {
	...
	public static final long TYPEID = 8897491527272666170;
	@Override
	public long getTypeId() {
		return TYPEID;
	}

	private final static class Log__ChoiceType extends Zeze.Transaction.Log<BModule, Integer> {
		public Log__ChoiceType(BModule self, int value) {
			super(self, value);
		}
		@Override
		...
		@Override
		public void Commit() {
			this.getBeanTyped()._ChoiceType = this.getValue();
		}
	}

	private final static class Log__ConfigType extends Zeze.Transaction.Log<BModule, Integer> {
		public Log__ConfigType(BModule self, int value) {
			super(self, value);
		}
		@Override
		public long getLogKey() {
		...
		@Override
		public void Commit() {
			this.getBeanTyped()._ConfigType = this.getValue();
		}
	}
	...
	public void BuildString(StringBuilder sb, int level) {
		sb.append(tangible.StringHelper.repeatChar(' ', level * 4)).Append("Zezex.Provider.BModule: {").Append(System.lineSeparator());
		level++;
		sb.append(tangible.StringHelper.repeatChar(' ', level * 4)).Append("ChoiceType").Append("=").Append(getChoiceType()).Append(",").Append(System.lineSeparator());
		sb.append(tangible.StringHelper.repeatChar(' ', level * 4)).Append("ConfigType").Append("=").Append(getConfigType()).Append("").Append(System.lineSeparator());
		sb.append("}");
	}
