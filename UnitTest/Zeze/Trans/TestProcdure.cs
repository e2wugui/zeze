...
namespace UnitTest.Zeze.Trans
{
    ...
    public class TestProcdure
    {
        ...
        public int ProcNest()
        {
            ...
            {
                int r = demo.App.Instance.Zeze.NewProcedure(ProcFalse).Call();
                Assert.IsTrue(r != Procedure.Success);
                Assert.AreEqual(bean.I, 1);
            }

            {
                int r = demo.App.Instance.Zeze.NewProcedure(ProcTrue).Call();
                Assert.IsTrue(r == Procedure.Success);
                Assert.AreEqual(bean.I, 123);
            }
        ...
        public void Test1()
        {
            ...
            int r = demo.App.Instance.Zeze.NewProcedure(ProcNest).Call();
            Assert.IsTrue(r == Procedure.Success);
